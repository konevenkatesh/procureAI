...
### Document Corpus (6 of 10 in KG) — Tier-1 findings across twelve typologies

| doc_id | PBG | EMD | BV | PVC | IP | LD | MA | E-Proc | BL | BG-Val | JP | Turn |
|--------|-----|-----|----|-----|----|----|----|--------|----|--------|----|------|
| vizag | HARD 2.5% | silence | ✓ 180d | ✓ | ADV none | ✓ 5%/mo | ✓ 10% | ✓ 100% | UNV grep (L36) | ✓ 60d-post-DLP | ADV bypass (EV=null, L27) | ✓ formula M=3 |
| judicial_academy | HARD 2.5% | ADV 1% | ✓ 90d | ✓ | ADV ml-only | ✓ PCC | ✓ 10% | ✓ 100% | ✓ WB/ADB | UNV grep (23 hits) | HARD bypass (zero JP) | ✓ formula M=2 |
| high_court | HARD 2.5% | ADV 1% | ✓ 90d | ✓ | ADV ml-only | ✓ PCC | ✓ 10% | ✓ 100% | ✓ bidder+WB | ✓ 60d-post-DLP | HARD bypass (zero JP) | ✓ formula M=2 |
| kakinada | silence | ADV 1% | ✓ 90d | ADV absent | ADV none | ✓ §48.3 | ✓ no-MA | UNV (L35) | ✓ AP self-decl | ✓ 28d-post-DLP | HARD bypass (zero JP) | ✓ formula M=3 |
| tirupathi | HARD 4.998% | HARD 0.998% | ✓ 180d | ADV absent | ADV ml-only | ✓ 0.1%/d | silence | ✓ 100% | UNV stitch | **GAP-VIOL 30d-post-COD (L37)** | HARD bypass (AP-GO-004) | **ADV 2.500× (128.75cr)** |
| vijayawada | HARD 5.001% | HARD 0.998% | ✓ 180d | ADV absent | ADV ml-only | ✓ 0.1%/d | silence | ✓ 100% | UNV stitch | **GAP-VIOL 30d-post-COD (L37)** | HARD bypass (AP-GO-004) | **ADV 2.500× (162.35cr)** |

**Total: 34 ValidationFindings (29 OPEN + 5 UNVERIFIED), 29 VIOLATES_RULE edges.** Twelve typologies × six documents = seventy-two possible finding slots: 29 OPEN violations, 5 UNVERIFIED-pending-review, 38 correctly silent. The 5 UNVERIFIED breakdown is unchanged from L38: 1 E-Proc (L35 Kakinada L24-fail) + 3 Blacklist (1 grep-fallback Vizag, 2 list-item-stitching Tirupathi/Vijayawada per L36) + 1 BG-Validity-Gap (L36 grep-fallback JA). The 2 BG-Validity-Gap GAP_VIOLATION findings on Tirupathi/Vijayawada reflect a PPP-shape knowledge-layer gap (L37). The Judicial-Preview-Bypass row is unique in the corpus: 6/6 documents trigger the violation, zero APJPA citations anywhere in 12 source markdown files (L38). The Turnover-Threshold-Excess row is the corpus's **first two-shape typology** (L39): 4 of 6 docs use the bid-capacity formula approach (COMPLIANT — formula approach IS the test); 2 of 6 use NREDCAP's fixed-INR turnover floor calibrated to 50%-of-total which mathematically equals 2.500× of annual contract value, just over the CVC-028 ≤2× cap → systemic NREDCAP-template-level finding (Tirupathi 128.75cr / Vijayawada 162.35cr, identical 2.500× multiple confirms it's boilerplate calibration not per-tender judgment).
