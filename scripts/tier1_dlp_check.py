...
def main() -> int:
    ...
    # COMPLIANT (rule fires AND L24 passes AND threshold met).
    # Bug C: explicit COMPLIANT_FIRED row (was silent pre-Bug-C).
    if is_compliant_l24 and not is_threshold_short:
        row = emit_verdict_row(
            ...
            value_extracted={"dlp_months": dlp_months,
                             "threshold_months": rule.get("threshold_months"),
