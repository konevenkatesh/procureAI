...
def main() -> int:
    ...
    llm_found_clause   = ld_present and (chosen is not None)
    ...
    if is_compliant:
        ...
        reason_label = "ld_absent_violation"
    ...
    finding_props = {
        ...
        "ld_clause_present":  llm_found_clause,    # mirrors LLM verdict (pre-L24)
        ...
        "human_review_reason": (
            ...
            f"line_end={line_end_local}) and confirm the LD clause is "
