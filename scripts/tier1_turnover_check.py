...
def main() -> int:
    ...
    # Bug C: COMPLIANT_FIRED row (was silent pre-Bug-C). Threshold-shape
    # with optional-clause semantics — absence/within-cap = compliant.
    if is_compliant:
        row = emit_verdict_row(
            ...
            value_extracted={"multiple_of_annual": multiple_of_annual,
                             "is_compliant_formula": is_compliant_formula,
                             "is_compliant_within_cap": is_compliant_within_cap,
